...
New-Item -ItemType Directory -Force -Path "results/train_scpflow" | Out-Null

Write-Host "[$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')] start train SCP-Flow"
...
Write-Host "[$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')] end train SCP-Flow"
